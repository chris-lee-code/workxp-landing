...
Categories.defaultProps = {
  ...
  title: {
    content: "There are more jobs than just players",
  ...
  description: {
    content:
      "The world is full of countless roles, and so do metaverses! We provide essential trainings for different roles to make the worlds more fruitful and active.",
    fontSize: "16px",
    fontWeight: "400",
    color: "#525f7f",
    lineHeight: "28px",
